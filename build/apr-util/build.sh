...
PROG=apr-util
VER=1.5.4
PKG=library/apr-util
SUMMARY="$PROG - Apache Portable Runtime Utility"
DESC="$SUMMARY"

DEPENDS_IPS="library/apr library/expat database/sqlite-3"
...
CPPFLAGS64="$CPPFLAGS64 -I/usr/include/$ISAPART"
CFLAGS="$CFLAGS -I/usr/include"
LDFLAGS32="$LDFLAGS32 -L/usr/lib -R/usr/lib"
LDFLAGS64="$LDFLAGS64 -L/usr/lib/$ISAPART64 -R/usr/lib/$ISAPART64"


CONFIGURE_OPTS="--with-apr=/usr
    --with-dbm=sdbm
    --with-ldap
    --without-pgsql
"
